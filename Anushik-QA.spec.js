describe('login',function()
{
    ...
    it('Verify that error validations are shown', () => {
        ...
        cy.get('.button-1.login-button').click();
        cy.get('.message-error.validation-summary-errors').should('contain',
    ...
    it('Verify Password forgote functionality', () => {
        ...
        cy.url('https://demo.nopcommerce.com/').should('contain','passwordrecovery');
    ...
    it('Verify login functionality with valid datas', () => {
        cy.get('#Email').clear().type('johnadams1@mail.ru')
            .should('have.value','johnadams1@mail.ru');
